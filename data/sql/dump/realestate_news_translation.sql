...
CREATE TABLE `news_translation` (
  ...
  PRIMARY KEY (`id`,`lang`),
  KEY `news_translation_id_idx` (`id`),
...
LOCK TABLES `news_translation` WRITE;
/*!40000 ALTER TABLE `news_translation` DISABLE KEYS */;
INSERT INTO `news_translation` VALUES (1,'<ol>\r\n<li>sadf asdf asdf asdfas fasf asdf asdf asdf adf adsf adf</li>\r\n<li>aasdas</li>\r\n</ol>','en'),(1,'<p>asd</p>','lv'),(1,'<p>asd</p>','ru'),(2,'sadf asdf asdf asdfas fasf asdf asdf asdf adf adsf adf','en'),(3,'sadf asdf asdf asdfas fasf asdf asdf asdf adf adsf adf','en'),(4,'sadf asdf asdf asdfas fasf asdf asdf asdf adf adsf adf','en'),(5,'sadf asdf asdf asdfas fasf asdf asdf asdf adf adsf adf as asd ','en');
